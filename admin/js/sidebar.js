...
function loadSidebar(activePage) {
    ...
    <ul class="nav flex-column p-3">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link text-white${activePage==='peticiones' ? ' active' : ''}" href="peticiones.html"><i class="bi bi-envelope me-2"></i>Peticiones</a>
        </li>
        <li class="nav-item mb-2">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link text-white${activePage==='ofertas' ? ' active' : ''}" href="ofertas.html"><i class="bi bi-tags me-2"></i>Ofertas</a>
        </li>
    </ul>`;
